       <section class="animate__animated animate__fadeIn">
                            ...
                            <ul class="flex text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
                                ...
                                <li id="" class="me-2 cp viewer optioner !text-blue-600 active" name="endofdayreportform" onclick="runoptioner(this)">
                                ...
                                <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                     <div class="grid grid-cols-1  lg:grid-cols-2 gap-10 p-3 bg-[#3b82f6] text-white rounded shadow-sm">
                                            <div class="form-group">
                                                ...
                                                <select onchange="checksalespointforendofday(this)" name="salespoint" id="salespointname2" class="form-control comp !text-black !bg-white">
                                                    <option value="">Loading...</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="logoname" class="control-label">Date</label>
                                                <input type="date" name="cdate" id="cdate" class="form-control !text-black !bg-white" placeholder="Search by Item Name">
                                            </div>
                                        </div>
                            ...
                            <hr class="my-10">
                             ...
                             <div >
                                 <div class="flex justify-end w-full my-4">
                                                 <button onclick="printContent('END OF DAY REPORT', null, 'endofdaysalesviewcontainer', true)" type="button" class="w-full h-[35px] md:w-max rounded-md text-white text-sm capitalize bg-gradient-to-tr from-green-400 via-green-500 to-primary-g px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                                    <div class="btnloader" style="display: none;"></div>
                                                    <span>print</span> 
                                                </button>
                                                 <button onclick="exportToExcel('endofdaysalesview', 'HEMS sales VIEW')" type="button" class="w-full mx-3 h-[35px] md:w-max rounded-md text-white text-sm capitalize bg-gradient-to-tr from-blue-400 via-blue-500 to-primary-g px-8 py-3 lg:py-2 shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
                                                    <div class="btnloader" style="display: none;"></div>
                                                    <span>Export to Excel</span> 
                                                </button> 
                                            </div>
                                <div class="table-content" id="endofdaysalesviewcontainer">
                                    <table id="endofdaysalesview">
                                        <thead>
                                            <tr>
                                                <th>s/n</th>
                                                <th>action</th>
                                                ...
                                                <th>Description</th>
                                                <th>Amount</th>
                                                <th class="pamount">Plan Amount</th>
                                                <th>Consumption</th>
                                                <th>VAT</th>
                            ...
                            <div id="endofdayreportmodal" onclick="if(event.target.id === 'endofdayreportmodal')this.classList.add('hidden')" class="hidden w-full h-full bg-[#0000004a] fixed top-0 left-0 overflow-y-auto flex justify-center items-start">
                                <div class="w-fit max-w-[90%] mt-8 min-w-[500px] h-fit min-h-[400px] bg-white p-2 rounded-md shadow-lg flex flex-col items-center">
                                    ...
                                    <div class="w-full py-2 flex justify-between mx-8">
                                        ...
                                        <span onclick="document.getElementById('endofdayreportmodal').classList.add('hidden')" class="cp material-symbols-outlined text-red-600 group-hover:text-primary-g"
                                           style="font-size: 20px;">close</span>
                                    </div>
