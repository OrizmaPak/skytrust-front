                                ...
                                <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 my-5">
                                        <div class="form-group">
                                            ...
                                            <!--<input type="text" name="" id="owner1" list="supplierlist2" onchange="checkdatalist(this, 'owner', 'supplierlist3')" class="form-control comp" placeholder="Enter Supplier">-->
                                            <!--<input type="text" name="owner" id="owner" class="form-control" placeholder="Enter Supplier">-->
                                            <input type="text" name="owner" id="owner" list="supplierlist2" onchange="checkdatalist(this)" class="form-control comp" placeholder="Enter Supplier">
                                        </div>
                                        <div class="form-group">
                                            <label for="logoname" class="control-label">Invoice No.</label>
                                            <input type="text" name="reference" id="reference" class="form-control comp" placeholder="Enter Order No.">
                                        </div>
                                        <div class="form-group">
                                            <label for="logoname" class="control-label">Amount Paid</label>
                                            <input type="number" name="amountpaid" id="amountpaid" class="form-control comp" placeholder="Enter Address">
                                        </div>
                                        <div class="form-group">
                                            <label for="logoname" class="control-label">Payment Method</label>
                                            <select type="text" name="paymentmethod" id="paymentmethod" class="form-control comp">
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 ">
                                        ...
                                        <div class="form-group">
                                            <label for="logoname" class="control-label">location</label>
                                            <select type="text" name="locationto" id="salespointnamemainstore" class="form-control comp">
                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                ...
                                                <th>quantity</th>
                                                <th>value</th>
                                                <th><button onclick="reqaddrowreceivepurchases()" title="Edit row entry" class="material-symbols-outlined rounded-full bg-primary-g h-8 w-8 text-white drop-shadow-md text-xs" style="font-size: 18px;">add</button></th>
                                            </tr>
                                        </thead>
                                        <tbody id="tabledata" class="">
                                           <tr id="reqrow_0">
                                                ...
                                                <td>
                                                    ...
                                                    <input onchange="rpreqcal(this)" type="number" id="cost_0" name="cost" class="form-control comp" placeholder="Enter Cost">
                                                </td>
                                                <td>
                                                    <label class="hidden">Quantity</label>
                                                    <input onchange="rpreqcal(this)" type="number" id="qty_0" name="qty" class="form-control comp" placeholder="Enter Quantity">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="flex gap-4 items-center h-full w-fit py-3">
                                                        <button onclick="this.parentElement.parentElement.parentElement.remove();receivepurchasestotalcount()" title="Edit row entry" class="material-symbols-outlined rounded-full bg-[red] h-8 w-8 text-white drop-shadow-md text-xs" style="font-size: 18px;">delete</button>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
