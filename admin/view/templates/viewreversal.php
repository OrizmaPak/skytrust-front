                            ...
                            <p class="page-title">
                              ...
                              <ul class="flex text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
                                ...
                                <li id="iddformform" class="me-2 cp updater optioner !text-blue-600 active" name="viewreversesales" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 capitalize">View Reversed Sales</p>
                                </li>
                                <li id="iddformform" class="me-2 cp updater optioner" name="viewreversereceipt" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 capitalize">View Reversed Receipt</p>
                                </li>
                            </ul>
                            <hr class="my-10">
