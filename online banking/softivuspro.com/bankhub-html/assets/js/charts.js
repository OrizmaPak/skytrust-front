...
if (weeklyTransactionsChart) {
  const chartData = {
    ...
    fill: {
      colors: ['#5D69F4', '#b72020', '#FFC861', '#FF6161', '#775DD0'],
    },
    plotOptions: {
      pie: {
        donut: {
...
if (AccountBalance) {
  const chartData = {
    ...
    fill: {
      colors: ['#4371E9', '#FFC861', '#b72020', '#FF6161'],
    },
    stroke: {
      lineCap: 'round',
    },
