                            ...
                            <!--</p>-->
                             ...
                             <ul class="flex text-sm font-medium text-center text-gray-500 border-b border-gray-200 cark:border-gray-700 cark:text-gray-400">
                                ...
                                <li id="" class="me-2 cp viewer optioner !text-blue-600 active" name="groupcheckinview" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 capitalize ">View Group Check In</p>
                                </li> 
                                <li id="iddcheckinform" class="me-2 cp updater optioner" name="groupcheckinform" onclick="runoptioner(this)">
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 capitalize">Group Check-In </p>
                                </li>
                            </ul>
