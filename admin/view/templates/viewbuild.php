       <section class="animate__animated animate__fadeIn">
                            ...
                            <div id="viewbuildmodal" onclick="if(event.target.id === 'viewbuildmodal')this.classList.add('hidden')" class="hidden w-full h-full bg-[#0000004a] fixed top-0 left-0 overflow-y-auto flex justify-center items-start">
                                <div class="w-fit max-w-[90%] mt-8 min-w-[500px] h-fit min-h-[400px] bg-white p-2 rounded-md shadow-lg">
                                    ...
                                    <div class="w-full py-2 flex justify-between">
                                        ...
                                        <span onclick="document.getElementById('viewbuildmodal').classList.add('hidden')" class="cp material-symbols-outlined group-hover:text-primary-g"
                                           style="font-size: 20px;">close</span>
                                    </div>
                                    
                                    <hr class="mb-4"/>
                                    
                                    <div id="modaldetails" class="flex gap-7 items-end max-w-[300px]">
