                            ...
                            <p class="page-title">
                             ...
                             <ul class="flex text-sm font-medium text-center text-gray-500 border-b border-gray-200 cark:border-gray-700 cark:text-gray-400">
                                ...
                                <li id="iddcheckinform" class="me-2 cp updater optioner" name="reassignroomsform" >
                                    <p class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 capitalize">Re-Assign room</p>
                                </li>
                            </ul>
                                ...
                                <!--            </div>-->
                                    ...
                                    <div class="flex flex-col  bg-white/90 p-5 pt-0 rounded-sm">
                                        ...
                                        <input type="hidden" id="olddue" name="" />
                                            ...
                                            <div class="grid grid-cols-1 !mb-2 lg:grid-cols-2 gap-10">
                                                <div class="grid grid-cols-1 !mb-2 lg:grid-cols-2 gap-10">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="amountpaid" id="amountpaid" onchange="calculatetotals()" class="bg-white form-control !p-2 comp2" placeholder="Enter Amount Paid">
                                                    </div>
                                                    <div class="form-group">
